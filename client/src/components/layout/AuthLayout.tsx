    ...
    <div className="min-h-screen relative flex items-center justify-center px-3 sm:px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 opacity-40">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-60 h-60 sm:w-80 sm:h-80 bg-gradient-to-br from-purple-400/30 to-emerald-400/30 rounded-full blur-3xl animate-float animation-delay-2000"></div>
          <div className="absolute top-1/2 right-1/3 w-48 h-48 sm:w-64 sm:h-64 bg-gradient-to-br from-emerald-400/30 to-blue-400/30 rounded-full blur-3xl animate-float animation-delay-4000"></div>
        </div>
        
        {/* Geometric patterns */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-10 left-10 w-3 h-3 sm:w-4 sm:h-4 bg-emerald-500 rotate-45 animate-spin-slow"></div>
          <div className="absolute top-20 right-20 w-4 h-4 sm:w-6 sm:h-6 bg-slate-700 rounded-full animate-pulse"></div>
        ...
        <div className="absolute inset-0">
          <div className="absolute top-1/6 left-1/6 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-emerald-500 rounded-full animate-particle-1"></div>
          <div className="absolute top-1/3 right-1/6 w-1 h-1 sm:w-1.5 sm:h-1.5 bg-slate-700 rounded-full animate-particle-2"></div>
