...
const fetchUsers = async (): Promise<TechadminUser[]> => {
  const { data } = await api.request<{ data: TechadminUser[] }>({
    method: 'GET',
    url: '/admin/users',
  })
  return data.data || []
...
const fetchDepartments = async (): Promise<TechadminDepartment[]> => {
  const { data } = await api.request<{ data: TechadminDepartment[] }>({
    method: 'GET',
    url: '/departments',
  })
  return data.data || []
...
const fetchSettings = async (): Promise<TechadminSettings> => {
  const { data } = await api.request<{ data: TechadminSettings }>({
    method: 'GET',
...
const createUser = async (payload: CreateUserInput): Promise<TechadminUser> => {
  const res = await api.request<{ data: TechadminUser }>({
    method: 'POST',
...
const createDepartment = async (payload: CreateDepartmentInput): Promise<TechadminDepartment> => {
  const res = await api.request<{ data: TechadminDepartment }>({
    method: 'POST',
...
const updateSettings = async (payload: Partial<TechadminSettings>): Promise<TechadminSettings> => {
  const res = await api.request<{ data: TechadminSettings }>({
    method: 'PUT',
