$files = @(
  'src\app\techadmin\page.tsx',
  'src\app\techadmin\users\page.tsx',
  'src\app\techadmin\departments\page.tsx',
  'src\app\techadmin\settings\page.tsx',
  'src\app\moderator\dashboard\page.tsx',
  'src\app\moderator\pending\page.tsx',
  'src\app\moderator\history\page.tsx',
  'src\app\moderator\analytics\page.tsx',
  'src\app\department\page.tsx',
  'src\app\department\staff\page.tsx',
  'src\app\department\analytics\page.tsx',
  'src\app\staff\page.tsx',
  'src\app\staff\completed\page.tsx',
  'src\app\mayor\page.tsx',
  'src\app\mayor\analytics\page.tsx',
  'src\app\issues\page.tsx',
  'src\app\users\page.tsx'
)

foreach ($f in $files) {
  $path = "c:\Users\alokyadav\Desktop\Alok\nayibareilly\client\$f"
  if (Test-Path $path) {
